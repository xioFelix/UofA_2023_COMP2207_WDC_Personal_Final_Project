...
router.post('/getChatHistory', function (req, res, next) {
  req.pool.getConnection(function (err, connection) {
    ...
    var query = "SELECT Messages.message_id, Messages.message, Messages.message_date, Users.user_name FROM Messages INNER JOIN Sellers ON Messages.seller_id = Sellers.seller_id INNER JOIN Users ON Sellers.user_id = Users.user_id WHERE Messages.user_id = ? ORDER BY Messages.message_date DESC;";
